...
if __name__ == '__main__':
    ...
    for i in range(1):
        ...
        parser.add_argument("--planning", type=str, default="none")
        parser.add_argument("--reasoning", type=str, default="io")
        parser.add_argument("--tooluse", type=str, default="io")
        ...
        print(f'total_completion_tokens:{completion_tokens}\ntotal_prompt_tokens:{prompt_tokens}\ntotal_price={completion_tokens*10/1000000+prompt_tokens*1.5/1000000}')

        env = os.environ.copy()
        print("-"*100)
        print(f"Current OUTPUT_DIR is {env['OUTPUT_DIR']}")
        print(f"Current TMP_DIR is {env['TMP_DIR']}")
        print(f"Current SUBMISSION_DIR is {env['SUBMISSION_DIR']}")
        print(f"Current EVALUATION_FILE_PATH is {env['EVALUATION_FILE_PATH']}")
        print("-"*100)
