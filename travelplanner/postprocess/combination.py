...
if __name__ == '__main__':
    ...
    idx_number_list = [i for i in range(151,181)]
    ...
    with open(f'{args.submission_file_dir}/{args.set_type}_{args.model_name}{suffix}_{args.mode}_submission.json','w',encoding='utf-8') as w:
