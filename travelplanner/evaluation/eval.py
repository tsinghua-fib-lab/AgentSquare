...
def eval_score(set_type: str, file_path: str):
    ...
    query_data_list = query_data_list[150:180]
    ...
    if set_type == 'train':
        ...
        result['Delivery Rate'] = delivery_cnt / 30
        result['Commonsense Constraint Micro Pass Rate'] = constraint_dis_record['commonsense']['pass'] / 300
        result['Commonsense Constraint Macro Pass Rate'] = final_commonsense_cnt / 30
        result['Hard Constraint Micro Pass Rate'] = constraint_dis_record['hard']['pass'] / 80
        result['Hard Constraint Macro Pass Rate'] = final_hardConstraint_cnt / 30
        result['Final Pass Rate'] = final_all_cnt / 30
